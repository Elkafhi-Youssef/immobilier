...
<div class="container">
                <div class="mb-4">
                   <div class="row-cols-2 d-flex justify-content-between mb-4" >
                    ...
                    <div class="col-6">
                        <div class="row">
                             <div class="col">
                                <a class="std_btn ml-md-4 btn btn-primary" role="button">Etudiants</a>
                            </div>
                            <div class="col">
                                <a class="tea_btn ml-md-4 btn btn-primary"  role="button">Enseignants </a>
                            </div>
                            <div class="col">
                                <a class="emp_btn ml-md-4 btn btn-primary"  role="button">Employés</a>
                            </div>
                        </div> 
                    </div>
                ...
                <div class="card- shadow- mb-4">
                    ...
                    <h2 class="ml-3" id="title">Etudiants</h2>
                    <hr class="sidebar-divider my-0">
                        <div class="card-body">
